...
## Fivemanage
[Fivemanage](https://fivemanage.com/?ref=Eldron-X) is an easy-to-use, all-in-one SaaS for game servers that provides logging.

<Steps>
    ### Create an account
    Sign up at [Fivemanage](https://fivemanage.com/?ref=Eldron-X).
    ### Make sure you have the `Hobby` or `Pro` plan. 
    You'll get a 14-days free trial if you do not already have an subscription, you can find more information [here](https://fivemanage.com/profile/billing?ref=Eldron-X) and on the [pricing](https://fivemanage.com/pricing?ref=Eldron-X) page.
    ### Create a new token
