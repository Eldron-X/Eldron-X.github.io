...
<ResourceLinks repo="https://github.com/Eldron-X/ox_target" />
...
### Download a [release](https://github.com/Eldron-X/ox_target/releases) or clone the source code.

```bash
git clone https://github.com/Eldron-X/ox_target.git
```
...
- [ox_core](https://github.com/Eldron-X/ox_core)
