...
<div className="flex flex-wrap gap-1">
  <GhButton link="https://github.com/Eldron-X/cfxlua-vscode" />
  <DownloadButton link="https://marketplace.visualstudio.com/items?itemName=Eldron-X.cfxlua-vscode" />
</div>
