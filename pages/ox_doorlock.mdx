...
<ResourceLinks repo="https://github.com/Eldron-X/ox_doorlock" />
...
### Download a [release](https://github.com/Eldron-X/ox_doorlock/releases) or build the source code.

```bash
git clone https://github.com/Eldron-X/ox_doorlock.git
cd ox_doorlock/web
pnpm i
pnpm build
```
