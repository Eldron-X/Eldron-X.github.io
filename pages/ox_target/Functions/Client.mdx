...
For some examples you can refer to [defaults.lua](https://github.com/Eldron-X/ox_target/blob/main/client/defaults.lua) or [debug.lua](https://github.com/Eldron-X/ox_target/blob/main/client/debug.lua).
