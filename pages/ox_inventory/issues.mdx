...
We provide an easy way for you to do this by downloading a pre-bundled release, which you can get from [here](https://github.com/Eldron-X/ox_inventory/releases/latest).  
